...
public class CreateReservationView extends JFrame {
    ...
    /**
     * Returns the guest name text field.
     *
     * @return the JTextField for guest name input
     */
    ...
    /**
     * Returns the check-in date text field.
     *
     * @return the JTextField for check-in date input
     */
    ...
    /**
     * Returns the check-out date text field.
     *
     * @return the JTextField for check-out date input
     */
     ...
     *
     * @return the JComboBox for selecting a hotel
     */
    ...
    /**
     * Returns the room combo box.
     *
     * @return the JComboBox for selecting a room
     */
    ...
    /**
     * Returns the discount code text field.
     *
     * @return the JTextField for discount code input
     */
     ...
     *
     * @return the JButton for confirming the reservation
     */
     ...
     *
     * @return the JButton for canceling the reservation
     */
